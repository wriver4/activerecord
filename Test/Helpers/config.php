<?php
/**
 * In order to run these unit tests, you need to install the required
...
ActiveRecord\Config::initialize(function($cfg)
{
    ...
    {
        $logger = new Log_file(dirname(__FILE__).'/../log/query.log', 'ident',
                array(
            'mode' => 0664,
    ...
    {
        if ($GLOBALS['show_warnings'] && !isset($GLOBALS['show_warnings_done'])) echo "(Logging SQL queries disabled, PEAR::Log not found.)\n";
    ...
    {
        if (!extension_loaded('memcache')) echo "(Cache Tests will be skipped, Memcache not found.)\n";
    }
