        ...
        extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assert_true(AR\all(null,
                        array(
            null,
            null)));
        $this->assert_true(AR\all(1, array(
            1,
            1)));
        $this->assert_false(AR\all(1, array(
            1,
            '1')));
        $this->assert_false(AR\all(null,
                        array(
            '',
            null)));
    }
    ...
    {
        $this->assert_equals('order_status',
