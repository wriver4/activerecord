        ...
        extends DatabaseTest
{
    ...
    public function test_extract_and_validate_options()
    {
        $args = array(
            'first',
            $this->options);
        $this->assert_equals($this->options,
    ...
    public function test_namespace_gets_stripped_from_inferred_foreign_key()
    {
        ...
        $this->assert_equals($table->get_relationship('parent_book')->foreign_key[0],
                'book_id');
        $this->assert_equals($table->get_relationship('parent_book_2')->foreign_key[0],
                'book_id');
        $this->assert_equals($table->get_relationship('parent_book_3')->foreign_key[0],
                'book_id');
    }
