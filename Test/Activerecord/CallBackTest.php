        ...
        extends \Test\Helpers\DatabaseTest
{
    ...
    {
        $this->assert_has_callback('before_destroy',
                'before_destroy_using_string');
    }
    ...
    {
        VenueCB::$before_create = array(
            'before_create_halt_execution');
        Activerecord\Table::clear_cache('VenueCB');
    ...
    {
        VenueCB::$before_update = array(
            'before_update_halt_execution');
        Activerecord\Table::clear_cache('VenueCB');
        $table = Activerecord\Table::load('VenueCB');
    ...
    {
        VenueCB::$before_destroy = array(
            'before_destroy_halt_execution');
        Activerecord\Table::clear_cache('VenueCB');
        $table = Activerecord\Table::load('VenueCB');
    ...
    {
        VenueCB::$before_validation = array(
            'before_validation_halt_execution');
        Activerecord\Table::clear_cache('VenueCB');
        $table = Activerecord\Table::load('VenueCB');
