        ...
        extends DatabaseTest
{
    ...
    public function test_insert_should_quote_keys()
    {
        $author = new Author(array(
            'name' => 'Blah Blah'));
        $author->save();
        $this->assertTrue(strpos($author->connection()->last_query,
    ...
    {
        if ($this->conn->supports_sequences()) $this->assertEquals($this->conn->get_sequence_name('authors',
    ...
    {
        if ($this->conn->supports_sequences()) $this->assertEquals(AuthorExplicitSequence::$sequence,
