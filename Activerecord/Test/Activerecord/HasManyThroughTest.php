        ...
        extends DatabaseTest
{
    ...
    {
        $user = User::find(1, ['include' => ['user_newsletters']]);
    ...
    {
        $user = User::find(1, ['include' => ['newsletters']]);
